              ...
              <Tabs.TabPane tab="Khách hàng" key="1">
                ...
                >
                  {imageUrl ? (
                    ...
                    <div className="ant-upload-text" style={{ width: 240 }}>
                      Upload {imageUrl}
                    </div>
                  )}
                </Upload>
                  ...
                  <Col span={12}>
                    <Form.Item label="Họ" required onChange={onCustomerChange}>
                      <Input
                        ...
                        value={customerUpdate.last_name}
                      />
                    </Form.Item>
                    ...
                    <Form.Item label="Ngày sinh" required>
                      <DatePicker
                        name="birthday"
                        onChange={(e) => onFieldChange("birthday", new Date(e))}
                        value={
                          customerUpdate.birthday
                            ? moment(customerUpdate.birthday, "YYYY-MM-DD")
                            : null
                        }
                      />
                    </Form.Item>
                  ...
                  <Col span={12}>
                    <Form.Item label="Tên" required onChange={onCustomerChange}>
                      <Input
                        name="first_name"
                        placeholder="input placeholder"
                        value={customerUpdate.first_name}
                      />
                    </Form.Item>
                ...
                <Row gutter={10}>
                  ...
                  <Col span={12}>
                    <Form.Item label="Mã zip" onChange={onAddressChange}>
                      <Input
                        name="zip"
                        value={customerUpdate.default_address?.zip}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item label="Tỉnh">
                      <Select
                        ...
                        name="province_code"
                        value={customerUpdate.default_address?.province_code}
                        onChange={(e) =>
                          onAddressFieldChange("province_code", e)
                        }
                      >
                  ...
                  <Col span={12}>
                    <Form.Item label="Huyện">
                      <Select
                        ...
                        onChange={(e) =>
                          onAddressFieldChange("district_code", e)
                        }
                      >
                        <Option value={null}>-- Vui lòng chọn --</Option>
                        {districts.map((item) => (
                  ...
                  <Col span={12}>
                    <Form.Item label="Xã.">
                      <Select
                        ...
                        placeholder="-- Vui lòng chọn --"
                        name="ward_code"
                        value={customerUpdate.default_address?.ward_code}
