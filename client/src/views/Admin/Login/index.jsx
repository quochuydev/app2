            ...
            <section id="login-form" className="m-b-lg">
              <form name="userForm" className="signin panel" style={{ minHeight: '200px', width: '100%', display: 'table' }} noValidate autoComplete="off">
                <div className="list-group" style={{}}>
                  ...
                  <div className="text-center m-b" style={{ color: '#999 !important' }}>
                    <p>Vui lòng đăng nhập để sử dụng dịch vụ</p>
                  </div>
                  {/* div style="margin-bottom: 26px; padding: 0 20px;">
              <div class="p-b-md">
                <div class="form-group"  show-errors>
                  <input type="text" autofocus id="username" name="username"  class="form-control input-login" placeholder="Email *" autocomplete="nope" required>
                  <div role="alert">
                    <p class="help-block error-text">Vui lòng nhập email</p>
                  </div>
                </div>
              </div>
              <div class="p-b-md">
                <div class="form-group" show-errors>
                  <input type="password" id="password" name="password" class="form-control input-login" placeholder="Mật khẩu *" autocomplete="new-password" required>
                  <div role="alert">
                    <p class="help-block error-text">Vui lòng nhập mật khẩu</p>
                  </div>
                </div>
              </div>
              <div class="text-center" style="width: 39%; margin: 0 auto">
                <button type="submit" class="btn btn-sm bgr-bluedark button-login">Đăng nhập</button>
              </div>
            </div>
            <div style="margin-bottom: 23px; box-shadow: inset 0 -1px 0 #eee; display: flex; justify-content: center; height: 1px">
              <p class="text-center text-small-brown" style="margin-top: -10px; background: white; padding: 0 5px; position: absolute">Hoặc</p>
            </div> */}
                  <div className="m-b">
                    <div style={{ padding: '0px 20px' }}>
                      {/* <button type="button" class="btn btn-sm bgr-blue button-login"
                style="width: 100%; font-size: 15px;" >Đăng nhập với HaraAccount</button> */}
                      <a style={{ display: 'flex', alignItems: 'center', background: '#fff', border: '1px solid #2962ff', boxSizing: 'border-box', borderRadius: '4px', height: '40px' }} href="#">
