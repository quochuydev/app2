...
AuthenticationAdapterSchema.statics.STATUS_LIST = Object.values(AuthenticationAdapterSchema.statics.STATUS);
...
const AuthenticationAdapterModel = mongoose.model('Authentication_Adapter', AuthenticationAdapterSchema);
