...
CartSchema.statics._update = async function (
  filter = {},
  data_update = {},
  option = { multi: true }
) {
...
CartSchema.statics._find = async function (
  filter = {},
  populate = {},
  options = { lean: true }
) {
...
CartSchema.statics._findOne = async function (
  filter = {},
  populate = {},
  options = { lean: true }
) {
...
CartSchema.statics._findOneAndUpdate = async function (
  filter = {},
  data_update = {},
