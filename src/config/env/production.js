module.exports = {
  ...
  haravan: {
    ...
    scope_install:
      "openid profile email org userinfo com.write_products com.write_orders com.write_customers com.write_shippings com.write_inventories grant_service offline_access wh_api",
