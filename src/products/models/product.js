...
ProductSchema.statics._find = async function (
  filter = {},
  populate = {},
  options = { lean: true }
) {
...
ProductSchema.statics._findOne = async function (
  filter = {},
  populate = {},
  options = { lean: true }
) {
...
ProductSchema.statics._findOneAndUpdate = async function (
  filter = {},
  data_update = {},
...
ProductSchema.statics._update = async function (
  filter = {},
  data_update = {},
  option = { multi: true }
) {
